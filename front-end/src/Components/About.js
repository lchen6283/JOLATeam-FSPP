      ...
      <div className="items-center justify-center flex items-center space-y-24 md:space-y-0 md:pt-10 lg:pt-0 flex-col md:flex-row justify evenly ">
        <div className="p-4 relative">
          <div className="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
            <a href="https://github.com/named-josie" className="block relative">
              <img
                alt="profil"
          ...
          <div className="bg-white rounded-lg shadow px-8 py-4 pt-24">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-800 font-normal">UI Designer</p>
              <p className="text-md text-gray-500 w-60 mx-auto py-4 font-light">
                Hello there, I'm Josie, a full-stack software engineer in NYC. I
                consider myself a naturally curious person which makes me want
                to always learn new things, a problem-solver who questions
                everything, and a hard worker who doesn't take life too
                seriously and enjoys the little small things in life like a good
                playlist or series not to mention podcast please feel free to
                recommend.
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow px-8 py-4 pt-24">
            <div className="text-center">
              ...
              <p className="text-md text-gray-500 w-60 mx-auto py-4 font-light">
                ...
                an intensive 12-month software engineering fellowship with a 9%
                acceptance rate. A goal-oriented person, open to acquiring
          ...
          <div className="bg-white rounded-lg shadow px-8 py-4 pt-24">
            <div className="text-center">
              ...
              <p className="text-md text-gray-500 w-60 mx-auto py-4 font-light">
                ...
                I am pursuing software engineering because I have always had a
                passion for technology. As a creative, I wish to explore the
                vast array of opportunities with this field. Once I obtain the
                knowledge and skills necessary to succeed as a developer, I want
                to build a career at companies that are shifting the world.
              </p>
            </div>
            <div className="pt-8 flex border-t border-gray-200 w-40 mx-auto text-gray-500 items-center justify-between">

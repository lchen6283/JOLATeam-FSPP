    ...
    <div className="w-full p-2 px-10 md:mt-0 lg:flex-shrink-0  ">
      ...
      <div className="mt-6 inline-flex rounded-md shadow">
        <button
          onClick={handleClick}
          type="button"
          className="py-2 px-24 bg-smakorange hover:bg-smakHighlight focus:ring-smakorange focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-full font-extrabold font-[Open Sans]"
        >
          START
        </button>
      </div>

...
export default function Search({ city, setCity, handleClick }) {
  ...
  return (
    <div className="w-full p-2 px-10 md:mt-0 lg:flex-shrink-0  bg-smakHighlight">
       <div className="p-3 md:mt-0 inline-flex rounded-md shadow top-17 left-1/2 -translate-x-1/6 -translate-y-1/6 ">
...
<div className="w-1/2 mx-auto justify-center">
      ...
      <div className="mt-12 inline-flex rounded-md shadow">
            <button
              onClick={handleClick}
              type="button"
              className="py-4 px-8 bg-smakorange hover:bg-smakHighlight focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
            >
              START
            </button>
          </div>

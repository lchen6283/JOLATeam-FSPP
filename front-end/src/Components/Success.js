...
function Success() {
  ...
  return (
    <div className="container mx-auto p-10 rounded-lg shadow-lg bg-orange-200 mb-5 border-[0.5rem] border-orange-400">
      <h2 className="p-4 text-center text-2xl font-extrabold text-white bg-smakHighlight rounded-xl">
        ...
        <div className="flex flex-col p-10">
          ...
          <ul className="text-left">
            <li className="my-0 text-xl font-semibold text-gray-600 dark:text-white">
              Restaurant: <span className="my-4 text-xl font-bold text-gray-800 font-[Open Sans]">{finalOrderData.restaurant_id.name}</span> 
            </li>
            <li className="my-0 text-xl font-semibold text-gray-600 dark:text-white">
              Cousine: <span className="my-4 text-xl font-bold text-gray-800 font-[Open Sans]">{finalOrderData.restaurant_id.matchedcategory['label']}</span> 
            </li>
            {/* <li className="my-0 text-xl font-semibold text-gray-600 dark:text-white">
          ...
          {finalOrderData.order_contents.map((item, i) => {
            return  <li 
                      ...
                      key={i}><MdCheckCircle className="w-6 h-6 py-0 px-0 my-1 mx-2 fill-gray-600 border-0 rounded-sm" /> 
                      {item.type} 
        ...
        <div className="flex flex-col ">
          ...
          <ul className="p-10 text-left">
            <li className="my-4 text-xl font-semibold text-gray-600 dark:text-white">
              Restaurant Address: <span className="my-4 text-xl font-bold text-gray-800 font-[Open Sans]">{finalOrderData.delivery_address}</span> 
            </li>
            <li className="my-4 text-xl font-semibold text-gray-600 dark:text-white">
              Delivery Address: <span className="my-4 text-xl font-bold text-gray-800 font-[Open Sans]">{finalOrderData.delivery_address}</span> 
            </li>
